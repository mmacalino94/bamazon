...
VALUES ("Kingdom Hearts 3","ENTERTAINMENT",49.95,150),
    ...
    ("Air Jordans 10","CLOTHING",75.00,5),
    ("Bomber Jacket","CLOTHING",54.25,35),
    ("Fire Starter Kit","SPORTS & OUTDOORS",42.42,42),
    ("Spirited Away","ENTERTAINMENT",15.00,25),
    ("Game of Thrones Complete Series","ENTERTAINMENT",85.50,57),
    ("Catan","ENTERTAINMENT",30.50,35),
    ("Cards Against Humanity","ENTERTAINMENT",15.00,23);
